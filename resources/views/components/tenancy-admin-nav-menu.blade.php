...
-->
{{-- TODO --}}
<div x-data="{ open: false, openMobileSidebar: false }">



    {{-- Mobile sidebar --}}
    <!-- Off-canvas menu for mobile, show/hide based on off-canvas menu state. -->
    <div x-show="openMobileSidebar" class="relative z-50 lg:hidden" role="dialog" aria-modal="true">
        <!--
                            ...
                            @foreach ($links as $link)
                                <li>
                                    <a href="{{ $link['url'] }}"
                                        ...
                                        {{-- <span class="text-sm text-gray-400"><i class="{{ $link['icon'] }}"></i></span> --}}
                                        {{ $link['name'] }}
                                    </a>
                                </li>
                            @endforeach
    ...
    <div class="lg:pl-72">
        ...
        <div
            ...
            <button x-on:click="openMobileSidebar = ! openMobileSidebar" type="button"
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <div x-data="{ openDropdown: false }" class="relative">
                        <button x-on:click="openDropdown = ! openDropdown" type="button"
                        ...
                        <div x-show="openDropdown"
                            ...
                            <a href="{{ route('adminx-logout') }}" class="block px-3 py-1 text-sm/6 text-gray-900"
