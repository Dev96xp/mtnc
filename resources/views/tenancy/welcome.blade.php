<x-tenancy-layout>
    ...
    <section>
        <div class="w-full h-screen mx-auto px-4 sm:px-6 lg:px-64 py-40 lg:py-52 opacity-75 relative bg-center bg-no-repeat bg-cover hover:opacity-85"
            style="background-image: url('{{ route('file', 'home/nucleo1.jpg') }}')">
            <div class="absolute left-10 lg:left-20 bottom-20">
                <div>
                    <p class="px-2 text-5xl md:text-8xl lg:text-8xl py-6"
                        ...
                        <div>
                            <span class="text-2xl lg:text-4xl font-bold text-blue-500 mr-2">Aqui va el nombre del negocio</span><span class="text-green-400 font-bold mx-2"> ACTIVE</span>
                        </div>
                ...
                <p class="flex justify-end text-black font-bold text-xl mt-2 mb-4" style="font-family: Montserrat">
                    Base / Omaha
                </p>
            </div>
        </div>
            ...
            <footer class="w-full text-gray-700 bg-gray-100 body-font">
                <div
                    ...
                    <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                        ...
                        <p class="font-bold text-xl">Nada</p>
                        <p class="mt-2 text-sm text-gray-500">Design, Code and Ship!</p>
                        <div class="mt-4">
                            <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                                <a href="#" class="text-gray-500 cursor-pointer hover:text-gray-700">
                    ...
                    <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        ...
                        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav class="mb-10 list-none">
                                ...
                                <li class="mt-3">
                                    <a class="text-gray-500 cursor-pointer hover:text-gray-900">Nucleus-Technologies</a>
                                </li>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="bg-gray-300">
                    <div class="container px-5 py-4 mx-auto">
                        <p class="text-sm text-gray-700 capitalize xl:text-center">Powered by Nucleus-Technologies ©
                            2024 All
                            rights reserved </p>
                        <p class="text-sm text-gray-700 capitalize lg:text-center">Nucleus-Technologies is a
                            Trademark with
                            Copyright 2024 Nucleus-Technologies. </p>
                    </div>
                </div>
            </footer>
