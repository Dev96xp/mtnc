...
<head>
    ...
    {{-- Font Awesome --}}
    {{-- Icons - Este archivo lo baje y lo copie en esta direcion, es la version 6 --}}
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <livewire:layout.app.navigation /> {{-- NEW  Barra de Navegacion PARA APLICACION CENTRAL --}}
        ...
        <h1 class="text-center text-gray-400">central ADMIN layout</h1>
